...
@pytest.fixture
def register_sample_tools(tmp_path):
    """Create and register sample tool files for testing.

    This fixture creates sample tool files in tmp_path that will be
    discovered and registered when create_app is called with tools_path=tmp_path.
    """
    # test category
    test_dir = tmp_path / "test"
    test_dir.mkdir()
