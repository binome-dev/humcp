...
async def pubmed_search(
    ...
    try:
        ...
        ncbi_api_key = await resolve_credential("NCBI_API_KEY")
        ...
        xml_root = await _fetch_article_details(pmids, api_key=ncbi_api_key)
...
async def pubmed_get_article(
    ...
    try:
        ...
        ncbi_api_key = await resolve_credential("NCBI_API_KEY")
        xml_root = await _fetch_article_details([pmid.strip()], api_key=ncbi_api_key)
