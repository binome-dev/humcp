...
def _get_lambda_client(aws_key: str, aws_secret: str, region: str | None = None):
    """Create a boto3 Lambda client with explicit credentials."""
...
async def aws_lambda_invoke(
    ...
    try:
        ...
        client = _get_lambda_client(aws_key, aws_secret, region)
