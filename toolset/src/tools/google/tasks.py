...
@tool()
async def google_tasks_list_task_lists(
    max_results: int = 100,
) -> TasksListTaskListsResponse:
    ...
    try:
        ...
        return TasksListTaskListsResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_list_task_lists failed")
        return TasksListTaskListsResponse(success=False, error=str(e))


@tool()
async def google_tasks_get_task_list(task_list_id: str) -> TasksGetTaskListResponse:
    ...
    try:
        ...
        return TasksGetTaskListResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_get_task_list failed")
        return TasksGetTaskListResponse(success=False, error=str(e))


@tool()
async def google_tasks_create_task_list(title: str) -> TasksCreateTaskListResponse:
    ...
    try:
        ...
        return TasksCreateTaskListResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_create_task_list failed")
        return TasksCreateTaskListResponse(success=False, error=str(e))


@tool()
async def google_tasks_delete_task_list(
    task_list_id: str,
) -> TasksDeleteTaskListResponse:
    """Delete a task list.
    ...
    try:
        ...
        def _delete():
            ...
            return TaskListDeleted(deleted_task_list_id=task_list_id)

        logger.info("tasks_delete_task_list id=%s", task_list_id)
        result = await asyncio.to_thread(_delete)
        return TasksDeleteTaskListResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_delete_task_list failed")
        return TasksDeleteTaskListResponse(success=False, error=str(e))
...
async def google_tasks_list_tasks(
    ...
    try:
        ...
        result = await asyncio.to_thread(_list)
        return TasksListTasksResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_list_tasks failed")
        return TasksListTasksResponse(success=False, error=str(e))


@tool()
async def google_tasks_get_task(
    task_list_id: str, task_id: str
) -> TasksGetTaskResponse:
    ...
    try:
        ...
        result = await asyncio.to_thread(_get)
        return TasksGetTaskResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_get_task failed")
        return TasksGetTaskResponse(success=False, error=str(e))
...
async def google_tasks_create_task(
    ...
    try:
        ...
        result = await asyncio.to_thread(_create)
        return TasksCreateTaskResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_create_task failed")
        return TasksCreateTaskResponse(success=False, error=str(e))
...
async def google_tasks_update_task(
    ...
    try:
        ...
        return TasksUpdateTaskResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_update_task failed")
        return TasksUpdateTaskResponse(success=False, error=str(e))
...
async def google_tasks_delete_task(
    ...
    try:
        ...
        def _delete():
            ...
            return TaskDeleted(deleted_task_id=task_id)

        logger.info("tasks_delete_task task_id=%s", task_id)
        result = await asyncio.to_thread(_delete)
        return TasksDeleteTaskResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_delete_task failed")
        return TasksDeleteTaskResponse(success=False, error=str(e))
...
@tool()
async def google_tasks_clear_completed(
    task_list_id: str = "@default",
) -> TasksClearCompletedResponse:
    ...
    try:
        ...
        def _clear():
            ...
            return TasksClearedCompleted(cleared=True, task_list_id=task_list_id)

        logger.info("tasks_clear_completed list_id=%s", task_list_id)
        result = await asyncio.to_thread(_clear)
        return TasksClearCompletedResponse(success=True, data=result)
    except Exception as e:
        logger.exception("tasks_clear_completed failed")
        return TasksClearCompletedResponse(success=False, error=str(e))
