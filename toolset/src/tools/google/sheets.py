...
@tool()
async def google_sheets_list_spreadsheets(max_results: int = 25) -> SheetsListResponse:
    ...
    try:
        ...
        spreadsheets = await asyncio.to_thread(_list)
        return SheetsListResponse(
            success=True,
            data=SheetsListData(spreadsheets=spreadsheets, total=len(spreadsheets)),
        )
    except Exception as e:
        logger.exception("sheets_list_spreadsheets failed")
        return SheetsListResponse(success=False, error=str(e))


@tool()
async def google_sheets_get_info(spreadsheet_id: str) -> SheetsGetInfoResponse:
    ...
    try:
        ...
        return SheetsGetInfoResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_get_info failed")
        return SheetsGetInfoResponse(success=False, error=str(e))
...
async def google_sheets_read_values(
    ...
    try:
        ...
        return SheetsReadValuesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_read_values failed")
        return SheetsReadValuesResponse(success=False, error=str(e))
...
async def google_sheets_write_values(
    ...
    try:
        ...
        return SheetsWriteValuesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_write_values failed")
        return SheetsWriteValuesResponse(success=False, error=str(e))
...
async def google_sheets_append_values(
    ...
    try:
        ...
        return SheetsAppendValuesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_append_values failed")
        return SheetsAppendValuesResponse(success=False, error=str(e))
...
async def google_sheets_create_spreadsheet(
    ...
    try:
        ...
        return SheetsCreateResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_create_spreadsheet failed")
        return SheetsCreateResponse(success=False, error=str(e))
...
async def google_sheets_add_sheet(
    ...
    try:
        ...
        return SheetsAddSheetResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_add_sheet failed")
        return SheetsAddSheetResponse(success=False, error=str(e))


@tool()
async def google_sheets_clear_values(
    spreadsheet_id: str, range_notation: str
) -> SheetsClearValuesResponse:
    ...
    try:
        ...
        return SheetsClearValuesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("sheets_clear_values failed")
        return SheetsClearValuesResponse(success=False, error=str(e))
