...
async def google_chat_list_spaces(
    ...
    try:
        ...
        return ChatListSpacesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("chat_list_spaces failed")
        return ChatListSpacesResponse(success=False, error=str(e))


@tool()
async def google_chat_get_space(space_name: str) -> ChatGetSpaceResponse:
    ...
    try:
        ...
        return ChatGetSpaceResponse(success=True, data=result)
    except Exception as e:
        logger.exception("chat_get_space failed")
        return ChatGetSpaceResponse(success=False, error=str(e))
...
async def google_chat_get_messages(
    ...
    try:
        ...
        result = await asyncio.to_thread(_get)
        return ChatGetMessagesResponse(success=True, data=result)
    except Exception as e:
        logger.exception("chat_get_messages failed")
        return ChatGetMessagesResponse(success=False, error=str(e))


@tool()
async def google_chat_get_message(message_name: str) -> ChatGetMessageResponse:
    ...
    try:
        ...
        result = await asyncio.to_thread(_get)
        return ChatGetMessageResponse(success=True, data=result)
    except Exception as e:
        logger.exception("chat_get_message failed")
        return ChatGetMessageResponse(success=False, error=str(e))
...
async def google_chat_send_message(
    ...
    try:
        ...
        return ChatSendMessageResponse(success=True, data=result)
    except Exception as e:
        logger.exception("chat_send_message failed")
        return ChatSendMessageResponse(success=False, error=str(e))
