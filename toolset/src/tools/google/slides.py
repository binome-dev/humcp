...
async def google_slides_list_presentations(
    ...
    try:
        ...
        return SlidesListPresentationsResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_list_presentations failed")
        return SlidesListPresentationsResponse(success=False, error=str(e))


@tool()
async def google_slides_get_presentation(
    presentation_id: str,
) -> SlidesGetPresentationResponse:
    ...
    try:
        ...
        def _get():
            ...
            for slide in presentation.get("slides", []):
                ...
                slides.append(SlideInfo(id=slide["objectId"], elements=elements))

            return PresentationDetailed(
        ...
        return SlidesGetPresentationResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_get_presentation failed")
        return SlidesGetPresentationResponse(success=False, error=str(e))
...
async def google_slides_create_presentation(
    ...
    try:
        ...
        return SlidesCreatePresentationResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_create_presentation failed")
        return SlidesCreatePresentationResponse(success=False, error=str(e))
...
async def google_slides_add_slide(
    ...
    try:
        ...
        return SlidesAddSlideResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_add_slide failed")
        return SlidesAddSlideResponse(success=False, error=str(e))
...
async def google_slides_add_text(
    ...
    try:
        ...
        return SlidesAddTextResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_add_text failed")
        return SlidesAddTextResponse(success=False, error=str(e))
...
async def google_slides_get_thumbnail(
    ...
    try:
        ...
        return SlidesGetThumbnailResponse(success=True, data=result)
    except Exception as e:
        logger.exception("slides_get_thumbnail failed")
        return SlidesGetThumbnailResponse(success=False, error=str(e))
